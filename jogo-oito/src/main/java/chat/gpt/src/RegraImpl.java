...
public class RegraImpl implements Regra {
    ...
    public boolean fazerMovimento(Tabuleiro tabuleiro, Posicao posicaoClicada) {
        ...
        if (podeMover(tabuleiro, posicaoClicada)) {
            ...
            Posicao posicaoVazia = getPosicaoVazia(tabuleiro);
    ...
    private Posicao getPosicaoVazia(Tabuleiro tabuleiro) {
        return tabuleiro.getTabuleiro().entrySet()
                .stream()
    ...
    private void trocarPosicao(Tabuleiro tabuleiro, Posicao posicaoClicada, Posicao posicaoVazia) {
        Peca pecaVazia = new Peca(tabuleiro.getValorPecaVazia());
    ...
    @Override
    public void reiniciarJogo(Tabuleiro tabuleiro) {
    ...
    private boolean podeMover(Tabuleiro tabuleiro, Posicao posicaoClicada) {
        return tabuleiro.getPeca(posicaoClicada).getValor() != tabuleiro.getValorPecaVazia();
    }
