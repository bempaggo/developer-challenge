...
public class GameStart {
    ...
    public static void startGame() {
        ...
        //inicia o GameService, que precisa do Grid para saber a posição do espaço vazio 
        //para poder movimentar as peças, e do enum GridConstants para saber o tamanho do Grid
